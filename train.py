...
#========================================================================                    
                    log_p1, log_p2, pred_score = model(cw_idxs, qw_idxs, cc_idxs, qc_idxs)
                    y2_mask = torch.zeros_like(y2) != y2
                    y2_mask = y2_mask.to(dtype=torch.float)
                    loss_BCE = nn.BCELoss()
                    loss_classify = loss_BCE(pred_score, y2_mask.to(dtype=torch.float).unsqueeze(1))
